...
def track_results(artifact):
    ...
    # AKTIVIERT AUTOMATISCHE DIAGRAMME (Feature Importance, Trainings-Kurven)
    #mlflow.lightgbm.autolog(log_models=False) # False, da du das Modell unten manuell loggst
